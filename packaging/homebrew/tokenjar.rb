class TokenJar < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Farukes/TokenJar/releases/download/v1.0.1/tokenjar-darwin-arm64.tar.gz"
      sha256 "9003d12f616077ccd13ff5b649dea347fcdaa287de74b617d1fbbd4da53e1618"
    else
      url "https://github.com/Farukes/TokenJar/releases/download/v1.0.1/tokenjar-darwin-x64.tar.gz"
      sha256 "d2149e96002442eeb35b95260259c392a478eef0646fe1cec3e527f1feebd980"
    end
  end

  on_linux do
    url "https://github.com/Farukes/TokenJar/releases/download/v1.0.1/tokenjar-linux-x64.tar.gz"
