...
def process_lockfile(
    ...
    if query and query.strip():
        ...
        if match_snippet:
            ...
            return (
                f"[TOKENJAR SHIELD: {base_name}] Package match for '{q_clean}':\n"
                f"```\n{match_snippet}\n```\n\n"
            ...
            return (
                f"[TOKENJAR SHIELD: {base_name}] Package '{q_clean}' was NOT found in {base_name}.\n"
