...
from token_saver.tools.symbol_index import register_symbol_index_tools
...
@mcp.resource("token-saver://guide")
...
@mcp.resource("token-saver://config")
def resource_config() -> str:
    """Active Token-Saver configuration settings."""
    import json
